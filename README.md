# Mathematical Optimization of Classification Models (SVM)

A rigorous exploration of the mathematical foundations of supervised learning. This project implements a classifier by solving the underlying optimization problem, proving a deep understanding of loss functions and boundary estimation.

### Mathematical Framework:
- **Dual Problem:** Implemented the solution to the SVM dual optimization problem using Lagrange multipliers, shifting the focus from weight vectors to support vector coefficients.
